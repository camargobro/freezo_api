import { postItensFreezer, getItens, putItem, deleteItem, getItemById, getItensMarca, getItensTipo, getItensValidade } from '../services/servicoFreezer.js';
...
export async function postItemFreezerController(req, res) {
    try {
            let body = req.body;
